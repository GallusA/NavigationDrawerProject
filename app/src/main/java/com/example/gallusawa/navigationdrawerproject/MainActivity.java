...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.first_fragment) {
            ...
            fm.beginTransaction().replace(R.id.frame, new ImportFragment()).commit();
            ...
            setTitle("Fourth Fragment");
            FourthFragment fragment = new FourthFragment();
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.frame, fragment, "fragment 4");
            fragmentTransaction.commit();

        } else if (id == R.id.fifth_fragment) {
            setTitle("Fifth Fragment");
            FifthFragment fragment = new FifthFragment();
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.frame, fragment, "fragment 5");
            fragmentTransaction.commit();

        } else if (id == R.id.sixth_fragment) {
            setTitle("Sixth Fragment");
            SixthFragment fragment = new SixthFragment();
            FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.frame, fragment, "fragment 6");
            fragmentTransaction.commit();
